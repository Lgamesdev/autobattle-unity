...
{
    public class UnitHandler : Character_Base
    {
        private Texture2D baseSpritesheetTexture;
        ...
        private Texture2D helmetTexture;
        ...
        /*private void UseItem(Item item)
    {
        ...
        private void UpdateTexture()
        {
            ...
            var spritesheetBasePixels = baseSpritesheetTexture.GetPixels(0, 0, 512, 512);
            ...
            if (hasArmor)
                texture.SetPixels(0, 256, 384, 128, chestTexture.GetPixels(0, 0, 384, 128));
            else
                texture.SetPixels(0, 256, 384, 128, GetBodyTexture().GetPixels(0, 0, 384, 128));

            if (hasSword) texture.SetPixels(0, 128, 128, 128, swordTexture.GetPixels(0, 0, 128, 128));
        ...
        public void SetGuestSpriteSheetData(GuestSpritesheetData guestSpritesheetData)
        {
            this.guestSpritesheetData = guestSpritesheetData;
        }

        public void SetCharacterEquipment(CharacterEquipmentManager equipmentManager)
        {
