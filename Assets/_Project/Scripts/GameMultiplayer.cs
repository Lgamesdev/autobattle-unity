...
public class GameMultiplayer : NetworkBehaviour
{
    ...
    private void NetworkManager_ConnectionApprovalCallback(NetworkManager.ConnectionApprovalRequest connectionApprovalRequest, NetworkManager.ConnectionApprovalResponse connectionApprovalResponse) {
        if (SceneManager.GetActiveScene().name != Loader.Scene.MenuScene.ToString()) {
    ...
    public void DestroyNetworkObject(NetworkObject networkObject) {
        DestroyNetworkObjectServerRpc(networkObject);
    }

    [ServerRpc(RequireOwnership = false)]
    private void DestroyNetworkObjectServerRpc(NetworkObjectReference networkObjectReference) {
