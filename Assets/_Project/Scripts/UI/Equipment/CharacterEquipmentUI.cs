...
namespace LGamesDev.UI
{
    public class CharacterEquipmentUI : MonoBehaviour
    {
        ...
        {
            var helmetItem = _equipmentManager.currentEquipment[(int)EquipmentSlot.Head];
            if (helmetItem != null)
            {
                _helmetSlot.SetEquipment(helmetItem.equipment);
            ...
            var armorItem = _equipmentManager.currentEquipment[(int)EquipmentSlot.Chest];
            if (armorItem != null)
            {
                _armorSlot.SetEquipment(armorItem.equipment);
            ...
            var weaponItem = _equipmentManager.currentEquipment[(int)EquipmentSlot.Weapon];
            if (weaponItem != null)
            {
                _weaponSlot.SetEquipment(weaponItem.equipment);
